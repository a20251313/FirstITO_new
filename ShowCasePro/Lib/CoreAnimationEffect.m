...
+(void)animationFadeOut:(UIView *)view
{
   ...
   [view.layer addAnimation:alphaAnimation forKey:nil];
    view.layer.opacity = 1;
}


+(void)animationWithSclarAndFadeOut:(UIView *)view
{
    
    CABasicAnimation *alphaAnimation = [CABasicAnimation animationWithKeyPath:@"transform.alpha"];
    alphaAnimation.fromValue = [NSNumber numberWithFloat:0.0f];
    alphaAnimation.toValue = [NSNumber numberWithFloat:1.0f];
...
// 星星闪烁动画
+(void)animationWithFlicker:(UIView *)view
{
    ...
    [view.layer addAnimation:animation forKey:@"opatity-animation"];
}
...
+(void)animationWIthRoationAndSclae:(UIView *)view
{
    
    CGFloat sclare_W = view.frame.size.height;
    
        
    [UIView animateWithDuration:0.5f animations:^{
        [view setTransform:CGAffineTransformMakeScale(220 /sclare_W, 220 /sclare_W)];
...
+(void)animationWIthRoationBackAndSclaeBack:(UIView *)view
{
    [UIView animateWithDuration:0.5f animations:^{
