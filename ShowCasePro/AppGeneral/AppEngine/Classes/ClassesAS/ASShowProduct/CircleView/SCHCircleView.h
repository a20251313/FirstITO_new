...
@property (nonatomic,weak)   id<SCHCircleViewDataSource> circle_view_data_source;
@property (nonatomic,weak)   id<SCHCircleViewDelegate>   circle_view_delegate;
