...
//    NSString *key = kDefaultSearchkey;
    ...
    if (key.length == 0) self.cities = _allCities;
    else {
...
//    [prompts sizeToFit];
    ...
    UITextField *prompts = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, 200, 30)];
    prompts.backgroundColor = [UIColor grayColor];
    self.searchTextField = prompts;
