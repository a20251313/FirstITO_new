...
@interface DimensionsViewController ()<ZBarReaderDelegate,UIImagePickerControllerDelegate>
{
...
{
    UIView *bar = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 1024, 64)];
