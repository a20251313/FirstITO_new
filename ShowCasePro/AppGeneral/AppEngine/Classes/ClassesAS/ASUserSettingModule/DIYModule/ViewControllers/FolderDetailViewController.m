...
@interface FolderDetailViewController () <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
...
{
    UICollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"FloderDetailCollectionViewCell" forIndexPath:indexPath];
    ((UIImageView *)[cell viewWithTag:kFolderImageView]).image = nil;
    Tdiydetail *diyDetail = [self.tDIYDetails objectAtIndex:indexPath.row];
    /**
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ((UIImageView *)[cell viewWithTag:kFolderImageView]).image = endImage;
        });
    });
    ...
    ((UILabel *)[cell viewWithTag:kFolderName]).text = diyDetail.product.name;
    ((UILabel *)[cell viewWithTag:kFolderCode]).text = diyDetail.product.code;
    ((UILabel *)[cell viewWithTag:kfolderEn]).text = diyDetail.product.name_en;
...
- (void)viewDidLoad
{
    ...
    [self.folderDetailCollectionView registerNib:[UINib nibWithNibName:@"FolderDetailCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:@"FloderDetailCollectionViewCell"];
