...
@interface RTFlyoutMenu : UIView<UITableViewDataSource,UITableViewDelegate>
...
@property (nonatomic, strong) NSArray *subMenuItemList;

@property (nonatomic, assign) int mainMenuIndex;

@property (nonatomic, strong) NSMutableArray *subMenuTableViewList;
...
// 子菜单行高度
@property (nonatomic) NSInteger subItemsCellHeight;

@property (nonatomic) NSInteger subMenuViewHeight;
