...
@interface InaxProductDetailView () <UIActionSheetDelegate,InaxProductIntroViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource,UIScrollViewDelegate>
{
    //产品图片
...
@implementation InaxProductDetailView
...
{
    InaxProductDetailView *pdv = [[InaxProductDetailView alloc] init];
