...
@interface InaxShopCartViewController () <UITableViewDataSource, UITableViewDelegate, NumberPadDelegate, UITextFieldDelegate, UIAlertViewDelegate, UIPopoverControllerDelegate, SavedCartsViewControllerDelegate, CartViewCellDelegate>
...
@implementation InaxShopCartViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        if ([nib count] > 0) {
            ...
            cell.contentView.backgroundColor = [UIColor colorWithRed:246./255 green:246./255 blue:246./255 alpha:1.];
            [cell.deleteButton setTitleColor:[UIColor colorWithRed:9./255 green:100./255 blue:200./255 alpha:1] forState:UIControlStateNormal];
            cell.countNumberLable.textColor = [UIColor colorWithRed:9./255 green:100./255 blue:200./255 alpha:1];
            cell.selectView.backgroundColor = [UIColor colorWithRed:246./255 green:246./255 blue:246./255 alpha:1];
            cell.countView.backgroundColor = [UIColor colorWithRed:246./255 green:246./255 blue:246./255 alpha:1];
            cell.imageButton.layer.borderWidth = 1;
            cell.imageButton.layer.borderColor = [UIColor blackColor].CGColor;
        }
        cell.delegate = self;
    }
    CartItem *item = [self cartItemAtIndexPath:indexPath];
