...
@interface InaxFavouriteViewController () <APPaginalTableViewDataSource, APPaginalTableViewDelegate, CommentChangeProtocol>
...
@implementation InaxFavouriteViewController
...
//    HMSegmentedControl *segmentedControl = [[HMSegmentedControl alloc] initWithSectionTitles:[NSArray arrayWithObjects:@"今天", @"九月", @"七月", @"六月", @"五月", @"四月", @"三月", nil]];
    ...
    [segmentedControl setBackgroundColor:[UIColor colorWithRed:246/255. green:246/255. blue:246/255. alpha:1]];
    [segmentedControl setTextColor:[UIColor colorWithRed:77/255. green:77/255. blue:77/255. alpha:1.]];
    [segmentedControl setSelectionIndicatorColor:[UIColor colorWithRed:0/255. green:128/255. blue:220/255. alpha:1.]];
...
- (void)initPaginalTableView
{
    ...
    {
        _paginalTableView = [[APPaginalTableView alloc] initWithFrame:CGRectMake(200, 85, 700, 683)];
    }
