...
{
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 85, 1024, 683)];
    ...
    findersViewController.view.frame = CGRectMake(25, 54 + 11, 974, 683);
    _foldersViewController = findersViewController;
    _foldersViewController.collectionView.backgroundColor = [UIColor colorWithRed:246./255. green:246./255. blue:246./255. alpha:1];
