...
#import "InaxErWeiMaViewController.h"
...
@interface InaxFolderDetailViewController () <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>

@property (nonatomic, strong) NSArray *tDIYDetails;

@end

@implementation InaxFolderDetailViewController
...
//    NSString *temp = @"{\"details\":[{\"productcode\":\"YBCT1500YQ(裙边、附溢水口)\",\"productimage\":\"data/productimage/YBCT1500YQ.png\",\"productname\":\"理想石浴缸\",\"floderid\":\"2\",\"update_time\":null,\"productid\":\"175\",\"version\":null}],\"foldername\":\"商务风格\",\"userid\":null,\"update_time\":null,\"cretae_date\":null,\"version\":null}";
    ...
    NSLog(@"%@", str);
    InaxErWeiMaViewController *erWeiMaViewController = [[InaxErWeiMaViewController alloc] initWithNibName:@"InaxErWeiMaViewController" bundle:nil];
