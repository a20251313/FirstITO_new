//
//  InaxSuiteCollectionViewController.m
//  ShowCasePro
//
...
#import "InaxSuitesCollectionSubViewController.h"
...
@interface InaxSuiteCollectionViewController ()<HVTableViewDataSource,HVTableViewDelegate>
{
...
@implementation InaxSuiteCollectionViewController
...
-(void)tableView:(UITableView *)tableView expandCell:(UITableViewCell *)cell withIndexPath:(NSIndexPath *)indexPath
{
    ...
    UserGuideTips *guideTips = [UserGuideTips shareInstance];
     [guideTips showUserGuideView:self.view tipKey:@"InaxSuiteTips11"  imageNamePre:@"InaxSuiteCollectionGuide"];
...
- (void) pushToSubViewcontroller:(NSString *)indexString
{
    ...
    {
        //进入次级界面
        InaxSuitesCollectionSubViewController *iscsc = [InaxSuitesCollectionSubViewController new];
        iscsc.selectedIndex = index;
        iscsc.dataArray = self.dataArray;
        [self.navigationController pushViewController:iscsc animated:NO];
    }
}
...
- (void)viewDidLoad
{
    ...
    suiteCollectionTableView = [[HVTableView alloc] initWithFrame:CGRectMake(0, 84, 1024, 685) expandOnlyOneCell:YES enableAutoScroll:YES];
