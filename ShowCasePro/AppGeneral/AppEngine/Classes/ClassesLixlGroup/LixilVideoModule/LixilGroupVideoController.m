//
//  LixilGroupVideoController.m
//  ShowCasePro
//
//  Created by yczx on 14-2-24.
//  Copyright (c) 2014年 yczx. All rights reserved.
//

#import "LixilGroupVideoController.h"
#import <MediaPlayer/MediaPlayer.h>
@interface LixilGroupVideoController ()
{
...
@implementation LixilGroupVideoController
- (IBAction)playVideo
{
    NSString *videoPath = @"data/brandvideo/lixilgroup/lixil_group_video.mp4";
