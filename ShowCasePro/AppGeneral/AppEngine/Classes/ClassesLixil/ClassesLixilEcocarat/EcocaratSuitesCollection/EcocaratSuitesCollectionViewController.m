//
//  EcocaratSuitesCollectionViewController.m
//  ShowCasePro
//
...
#define Inax_Suites_Collection_Cell_Height_Expand   410
...
@interface EcocaratSuitesCollectionViewController ()<HVTableViewDataSource,HVTableViewDelegate>
{
...
@implementation EcocaratSuitesCollectionViewController
...
- (void) pushToSubViewcontroller:(NSString *)indexString
{
    ...
    {
        //进入次级界面
        EcocaratSuitesCollectionSubViewController *escsc = [EcocaratSuitesCollectionSubViewController new];
        escsc.selectedIndex = index;
        escsc.dataArray = self.dataArray;
        [self.navigationController pushViewController:escsc animated:NO];
    }
}
