...
@interface LixilFavouriteViewController () <APPaginalTableViewDataSource, APPaginalTableViewDelegate, CommentChangeProtocol>
...
@implementation LixilFavouriteViewController
...
//    HMSegmentedControl *segmentedControl = [[HMSegmentedControl alloc] initWithSectionTitles:[NSArray arrayWithObjects:@"今天", @"九月", @"七月", @"六月", @"五月", @"四月", @"三月", nil]];
    ...
    [segmentedControl setSelectionIndicatorColor:[UIColor colorWithRed:233/255. green:87/255. blue:0/255. alpha:1.]];
